...
async function main() {
    try {
        ...
        await contract.submitTransaction('CreateAsset', 'asset6', 'Harsh', 100);
        console.log('Transaction has been submitted');

        var result = await contract.evaluateTransaction('ReadAsset', 'asset6');
        console.log(`Asset details: ${result.toString()}`);

        await contract.submitTransaction('UpdateAsset', 'asset6', 'Harsh-New', 200);
        ...
        await contract.submitTransaction('DeleteAsset', 'asset6');
